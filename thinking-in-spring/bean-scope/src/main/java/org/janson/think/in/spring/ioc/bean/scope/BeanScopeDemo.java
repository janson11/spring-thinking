...
public class BeanScopeDemo implements DisposableBean {
    ...
    public static void main(String[] args) {
        ...
        // Prototype Bean 无论依赖查找还是依赖注入，均为新生成的一个对象
        ...
        // 结论三：
        // 无论是Singleton还是Prototype Bean均会执行初始化回调
        // 不过仅Singleton会执行销毁方法回调
    ...
    public void destroy() throws Exception {
        System.out.println("当前 BeanScopeDemo Bean正在销毁中...");
        ...
        for (Map.Entry<String, User> entry : this.users.entrySet()) {
            ...
            if (beanDefinition.isPrototype()) {// 如果当前bean是 prototype Bean
